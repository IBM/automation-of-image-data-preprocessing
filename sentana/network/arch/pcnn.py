...
class PCNN(object):
    ...
    def build_arch(self):
        ...
        pool1 = tf.nn.max_pool(value=conv1, ksize=[1, 4, 4, 1], name="pool1",
        ...
        pool2 = tf.nn.max_pool(value=conv2, ksize=[1, 2, 2, 1], name="pool2",
        ...
        with tf.variable_scope("fc1") as scope:
            reshape = tf.reshape(norm2, [cf.batch_size, -1])
