...
@BaseGraph.register
class ContRotGraph(BaseGraph):
    """
    This class implements a tensorflow graph for a policy-network for policy gradient method in reinforcement learning,
    applying to continuous rotation action.
    """
